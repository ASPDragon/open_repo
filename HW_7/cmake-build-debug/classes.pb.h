...
class FullName final :
 ...
 public:
  ...
  bool has_patronimic() const;
  private:
  bool _internal_has_patronimic() const;
  public:
  ...
  PROTOBUF_NODISCARD std::string* release_patronimic();
...
class Student final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::foo::bar::FullName* release_full_name();
...
// optional string patronimic = 3;
inline bool FullName::_internal_has_patronimic() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool FullName::has_patronimic() const {
  return _internal_has_patronimic();
}
...
inline std::string* FullName::mutable_patronimic() {
  std::string* _s = _internal_mutable_patronimic();
...
inline std::string* FullName::release_patronimic() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = patronimic_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (patronimic_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline ::foo::bar::FullName* Student::mutable_full_name() {
  ::foo::bar::FullName* _msg = _internal_mutable_full_name();
...
inline ::foo::bar::Student* StudentsGroup::add_student() {
  ::foo::bar::Student* _add = _internal_add_student();
