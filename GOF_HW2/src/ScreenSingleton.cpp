...
public:
  virtual void ClrScr() override {
      FileLoggerSingletonProxy::getInstance().WriteToLog("ClrScr invoke begin");
      getInternalInstance().ClrScr();
      FileLoggerSingletonProxy::getInstance().WriteToLog("ClrScr invoke end");
  }
  virtual void GotoXY(double x, double y) override {

      FileLoggerSingletonProxy::getInstance().WriteToLog("GotoXY invoke begin");
      getInternalInstance().GotoXY(x, y);
      FileLoggerSingletonProxy::getInstance().WriteToLog("GotoXY invoke end");
  }
